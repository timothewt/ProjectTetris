...
public class SShape extends Tetrominoe {
        ...
        if (canRotate(grid)) {
            switch (this.orientation % 4) {
                case 0 -> {
                    ...
                    grid = setPieceCells(grid, color, new Coordinates(-1, 0), new Coordinates(0, 0), new Coordinates(0, 1), new Coordinates(1, 1));
                }
                case 1 -> {
                ...
                case 2 -> {
                    grid = setPieceCells(grid, BLACK, new Coordinates(0, 1), new Coordinates(0, 0), new Coordinates(1, 0), new Coordinates(1, -1));
                    grid = setPieceCells(grid, color, new Coordinates(-1, -1), new Coordinates(0, -1), new Coordinates(0, 0), new Coordinates(1, 0));
                }
                case 3 -> {
    ...
    public Grid moveDown(Grid grid) {
        if (canMoveDown(grid)) {
            grid = moveDownGlobal(grid, new Coordinates[]{new Coordinates(0,-1),new Coordinates(0,0),new Coordinates(-1,0),new Coordinates(-1,1)},
    ...
    public Grid moveSide(Grid grid, int direction) {
        if (canMoveSide(grid, direction)) {
            grid = moveSideGlobal(grid, new Coordinates[]{new Coordinates(0,-1),new Coordinates(0,0),new Coordinates(-1,0),new Coordinates(-1,1)},
                    new Coordinates[]{new Coordinates(-1,0),new Coordinates(0,0),new Coordinates(0,1),new Coordinates(1,1)},
                    new Coordinates[]{new Coordinates(1,-1),new Coordinates(1,0),new Coordinates(0,0),new Coordinates(0,1)},
    ...
    public Grid placePiece(Grid grid) {
        if (canPlacePiece(grid)) {
            grid = setPieceCells(grid, this.color, new Coordinates(0,-1), new Coordinates(0,0), new Coordinates(-1,0), new Coordinates(-1,1));
        }
        return grid;
    }
}
